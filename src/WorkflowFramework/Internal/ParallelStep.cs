...
/// </summary>
internal sealed class ParallelStep(IReadOnlyList<IStep> steps) : IStep
{
    private readonly IReadOnlyList<IStep> _steps = steps ?? throw new ArgumentNullException(nameof(steps));
